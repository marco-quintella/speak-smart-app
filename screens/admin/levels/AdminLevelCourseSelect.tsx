...
export type AdminLevelCourseSelectScreenProps = NativeStackScreenProps<AppNavigatorParamList, 'AdminLevelCourseSelectScreen'>;

export default function AdminLevelCourseSelectScreen ({ navigation, route }: AdminLevelCourseSelectScreenProps) {
